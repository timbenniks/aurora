...
export const mobileHeaderClass =
  "sticky top-0 z-30 flex min-h-14 items-center gap-3 border-b-2 border-border-subtle bg-muted/95 px-4 pt-[env(safe-area-inset-top)] shadow-[0_4px_0_0_var(--voxel-shadow)] backdrop-blur-sm md:hidden"

export const mobileStickyFooterClass =
  "fixed inset-x-0 bottom-0 z-30 flex flex-col gap-2 border-t-2 border-border-subtle bg-muted/95 p-4 pb-[max(1rem,env(safe-area-inset-bottom))] shadow-[0_-4px_0_0_var(--voxel-shadow)] backdrop-blur-sm md:hidden"
